...
import { Play, Download, Users, Zap, Shield, Gamepad2, ArrowRight, Globe, Star } from "lucide-react";
  ...
  return (
    <Layout showSidebar={false}>
      <div className="min-h-screen">
        {/* Hero Section */}
        <section className="section min-h-[90vh] flex items-center justify-center text-center" data-ui-section="hero">
          <div className="max-w-4xl mx-auto">
            <div className="mb-8">
              <img 
                ...
                onError={(e) => {
                  ...
                  fallback.className = 'w-32 h-32 mx-auto mb-8 bg-white rounded-full flex items-center justify-center text-black text-4xl font-bold border-4 border-gray-300';
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
                The premier platform for Eaglercraft HTML5 gaming. Join thousands of players in an immersive Minecraft experience, right in your browser.
              </p>
            </div>
            ...
            {/* Teaser Features */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16" data-ui-section="features-preview">
              <div className="card text-center backdrop-blur-sm bg-gray-900/40 border-gray-700 hover:bg-gray-900/60 transition-all duration-300">
                ...
                <p className="text-gray-300">Play instantly without downloads. Access your games from anywhere.</p>
              </div>
              <div className="card text-center backdrop-blur-sm bg-gray-900/40 border-gray-700 hover:bg-gray-900/60 transition-all duration-300">
                <Users className="w-12 h-12 text-green-400 mx-auto mb-4" />
                <h3 className="text-xl font-semibold mb-2">Social Gaming</h3>
                <p className="text-gray-300">Connect with friends, chat, and build together in multiplayer worlds.</p>
              </div>
              <div className="card text-center backdrop-blur-sm bg-gray-900/40 border-gray-700 hover:bg-gray-900/60 transition-all duration-300">
                <Zap className="w-12 h-12 text-yellow-400 mx-auto mb-4" />
                <h3 className="text-xl font-semibold mb-2">High Performance</h3>
                <p className="text-gray-300">Optimized servers ensure smooth gameplay with minimal lag.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="section py-20 bg-black/50 backdrop-blur-sm" data-ui-section="why-choose">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold mb-6">Why Choose UEC Launcher?</h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Built by gamers, for gamers. Experience Eaglercraft like never before with our cutting-edge platform.
              </p>
            </div>
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Jump into any Eaglercraft client with a single click. No complex setups or installations required.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Enterprise-grade security and 99.9% uptime ensure your gaming experience is always protected.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Join thousands of active players, make friends, and participate in community events.</p>
                  </div>
                </div>
              </div>
        ...
        <section className="section py-16" data-ui-section="trust">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-gray-300 text-lg">
              "The best Eaglercraft platform I've ever used. Fast, reliable, and packed with features."
            </p>
        ...
        {/* Final CTA */}
        <section className="section py-20 bg-gradient-to-r from-blue-600/20 to-purple-600/20" data-ui-section="final-cta">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Your Adventure Awaits</h2>
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Join UEC Launcher today and discover why we're the preferred choice for Eaglercraft enthusiasts worldwide.
            </p>
        ...
        {/* Footer */}
        <footer className="bg-black/80 border-t border-gray-800 py-12" data-ui-section="footer">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-400">
                  ...
                  <li><span className="opacity-50">Game Clients</span></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-400">
                  <li><span className="opacity-50">Forums</span></li>
                  <li><span className="opacity-50">Discord</span></li>
                  <li><span className="opacity-50">Events</span></li>
                </ul>
              </div>
