        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              The Premier <span className="text-uec-accent">Eaglercraft</span>{" "}
              Platform
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              UEC Launcher is a comprehensive HTML5 Minecraft gaming platform
              designed to provide the best Eaglercraft experience with modern
              features, social connectivity, and seamless gameplay.
            </p>
          </div>
          ...
          <div className="card mb-12">
            <div className="text-center">
              ...
              <p className="text-gray-300 text-lg max-w-3xl mx-auto">
                To create the most comprehensive, user-friendly, and
                feature-rich platform for Eaglercraft gaming, fostering a
                vibrant community where players can connect, compete, and create
                lasting memories.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <div className="card text-center">
              ...
              <p className="text-gray-400">
                Access various Eaglercraft clients including 1.5.2, 1.8.8, and
                specialized versions with OptiFine support.
              </p>
            </div>
            ...
            <div className="card text-center">
              ...
              <p className="text-gray-400">
                Connect with friends, chat in real-time, join groups, and
            ...
            <div className="card text-center">
              ...
              <p className="text-gray-400">
                Optimized servers with 99.9% uptime, low latency, and smooth
                gameplay experience across all devices.
              </p>
            </div>
            ...
            <div className="card text-center">
              ...
              <p className="text-gray-400">
                Enterprise-grade security with moderation tools, content
                filtering, and user safety features.
              </p>
            </div>
            ...
            <div className="card text-center">
              ...
              <p className="text-gray-400">
                Join thousands of players worldwide in a diverse, inclusive
                gaming community with 24/7 support.
              </p>
            </div>
          ...
          <div className="card mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <p className="text-gray-400">
                  Continuously improving and adding new features to enhance the
                  gaming experience.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-400">
                  Building a welcoming, inclusive environment where all players
                  feel at home.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-400">
                  Maintaining high standards in performance, security, and user
                  experience.
                </p>
              </div>
            </div>
          ...
          <div className="card bg-gradient-to-r from-blue-600/20 to-purple-600/20 border-blue-600/30 text-center">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <button className="button-secondary px-6 py-3">
                Join Discord
              </button>
