            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Review flagged content and moderate chat violations
                </p>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-yellow-400">
                    {
                      flaggedMessages.filter((m) => m.status === "pending")
                        .length
                    }
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-400">
                    {
                      flaggedMessages.filter((m) => m.status === "resolved")
                        .length
                    }
                  </p>
                </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span
                            className={`px-2 py-1 rounded-full text-xs ${getReasonColor(message.reason)}`}
                          >
                            {message.reason.replace("_", " ").toUpperCase()}
                          </span>
                        </div>
                        <div className="text-sm text-gray-400">
                          in {message.chatLocation} • Reported by{" "}
                          {message.reporter.displayName}
                        </div>
                      </div>
                    </div>
