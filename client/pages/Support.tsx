                  ...
                  {[
                    {
                      ...
                      description:
                        "Troubleshoot loading issues with game clients",
                    },
                    {
                      title: "Friend requests not working",
                      description: "Fix problems with the friends system",
                    },
                    {
                      title: "Account login problems",
                      description: "Resolve authentication and login issues",
                    },
                    {
                      title: "Chat not working",
                      description: "Fix messaging and chat functionality",
                    },
                  ].map((issue, index) => (
                    <div
                      key={index}
                      className="p-4 border border-gray-700 rounded-lg hover:bg-gray-800/50 transition-colors cursor-pointer"
                    >
              ...
              {isAuthenticated ? (
                <>
                  ...
                  <div className="space-y-4">
                    {mockTickets.map((ticket) => (
                      <div
                        key={ticket.id}
                        className="card hover:bg-gray-800/50 transition-colors cursor-pointer"
                      >
                ...
                <div className="card text-center py-12">
                  ...
                  <p className="text-gray-400">
                    You need to be logged in to access your support tickets.
                  </p>
                </div>
              )}
            </div>
              ...
              <div className="card">
                ...
                {isAuthenticated ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-400">
                      You need to be logged in to submit support tickets.
                    </p>
                  </div>
                )}
              </div>
                ...
                {[
                  {
                    ...
                    answer:
                      "Go to the Dashboard, select your preferred client from the dropdown, and click 'Launch'. The game will open in a new tab.",
                  },
                  {
                    question: "Why can't I add friends?",
                    answer:
                      "Make sure you're logged in and have the correct username. Friend requests may take a moment to appear.",
                  },
                  {
                    question: "How do I change my password?",
                    answer:
                      "Go to Profile Settings > Account & Security and use the Change Password section.",
                  },
                  {
                    question: "What are the different user roles?",
                    answer:
                      "Member (default), VIP (premium), VIP+ (premium plus), Moderator (chat moderation), and Admin (full access).",
                  },
                ].map((faq, index) => (
                  <div
                    key={index}
