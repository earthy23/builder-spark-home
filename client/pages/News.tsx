...
const mockNews: NewsArticle[] = [
  {
    ...
    excerpt:
      "We are excited to announce the release of UEC Launcher 2.0 with improved performance, new features, and better user experience.",
  ...
  },
  {
    ...
    excerpt:
      "A new high-performance Eaglercraft 1.8.8 server is now available with enhanced features and plugins.",
    content: "Full article content...",
    author: "Server Admin",
  ...
  },
  {
    ...
    excerpt:
      "Join our monthly building competition! Show off your creativity and win amazing prizes.",
    content: "Full article content...",
