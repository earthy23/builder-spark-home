                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="relative">
                        ...
                        <div
                          className={`absolute -bottom-1 -right-1 w-3 h-3 rounded-full border border-gray-900 ${getStatusColor(currentConversation.participant.status)}`}
                        ></div>
                      </div>
                      ...
                      <div>
                        <h3 className="font-semibold flex items-center gap-2">
                          ...
                          <span
                            className={`text-xs ${getRankColor(currentConversation.participant.rank)}`}
                          >
    ...
    >
      <div className="flex items-center gap-3">
        <div className="relative">
          ...
          <div
            className={`absolute -bottom-1 -right-1 w-4 h-4 rounded-full border-2 border-gray-900 ${getStatusColor(conversation.participant.status)}`}
          ></div>
        </div>
