                  ...
                  <div className="flex items-center gap-6 mb-8 pb-6 border-b border-gray-700">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        <span className="text-sm text-yellow-400 capitalize">{user?.role}</span>
                      </div>
                    </div>
                  </div>
                      ...
                      <div key={key} className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-400">
                            ...
                            {key === 'gameInvites' && 'Get notified when friends invite you to games'}
                      ...
                      <div key={key} className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-400">
                            ...
                            {key === 'showGameActivity' && 'Show what games you\'re currently playing'}
                          </p>
                        </div>
                        <label className="relative inline-flex items-center cursor-pointer">
                          <input
